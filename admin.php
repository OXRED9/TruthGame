      ...
      <form method="POST" action="Server.php">
         <div class="form-row" style="text-align: center; margin-top:170px; justify-content: center;">
            <div class="col-md-4 mb-3 justify-content-center">
               <h1 style="color:red;">اسم المستخدم</h1>
               ...
               <br>
               <h1 style="color:red;">كلمة المرور</h1>
               ...
               <?php } ?>
               <br>
               <input type="submit" name="adminBtn" value="دخول" class="btn btn-dark" style="width: 200px; height:60px;">
            </div>
         </div>
      </form>
   </body>
