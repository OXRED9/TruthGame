         ...
         <div class="form-row" style="text-align: center; margin-top:30px; justify-content: center;">
            <div class="col-md-4 mb-3 justify-content-center md-form">
               <?php if (isset($_SESSION['error'])) { ?>
                  ...
                  <br>
               <?php } ?>
               <h1 style="color:#C4C4C4;">السؤال الأول</h1>
               ...
               <br>
               <h1 style="color:#C4C4C4;">السؤال الثاني</h1>
               ...
               <br>
               <h1 style="color:#C4C4C4;">السؤال الثالث</h1>
               ...
               <br>
               <input type="submit" name="sendBtn" value="أرسل" class="btn btn-dark" style="width: 200px; height:60px;">
            </div>
         </div>
      </form>
