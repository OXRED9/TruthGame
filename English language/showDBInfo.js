 ...
 function nextPage() {
     if (typeof(arrayOf[counter]) == "undefined") {
         ...
         document.getElementById('first').innerHTML = "That's it (:";
 ...
 function previousPage() {
     if ((typeof(arrayOf[counter - 1]) == "undefined" || numOfQuest - 1 == 0) && counter != arrayOf.length + 1) {
         document.getElementById('first').innerHTML = "Press next to shwo the first question (:";
         document.getElementById('pointer').innerHTML = null;
         counter = 0;
         numOfQuest = 0;
     } else {
 ...
 function numOfQuestMeth() {
     document.getElementById('pointer').innerHTML = "question number | " + numOfQuest;
 }
